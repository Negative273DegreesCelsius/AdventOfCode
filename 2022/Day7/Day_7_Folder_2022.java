...
public class Day_7_Folder_2022 {
    private String name;
    private ArrayList<Integer> fileSizes = new ArrayList<>();
    private ArrayList<Day_7_Folder_2022> innerFolders = new ArrayList<>();
    private Day_7_Folder_2022 outerFolder;
    ...
    public Day_7_Folder_2022() { // the outermost folder "/ "
        this.name = "/";
    }

    public Day_7_Folder_2022(String name, Day_7_Folder_2022 outerFolder) {
        this.name = name;
    ...
    public ArrayList<Day_7_Folder_2022> getInnerFolders() {
        return this.innerFolders;
    }

    public Day_7_Folder_2022 getOuterFolder() {
        return this.outerFolder;
    }

    public int getSizeOfDir() {
        int total = getTotalSize();
        for (Day_7_Folder_2022 folder : innerFolders) {
    ...
    public void addFolder(String name) {
        innerFolders.add(new Day_7_Folder_2022(name, this));
    }
    ...
    public int getSmallestAccepted() {
        for (Day_7_Folder_2022 folder : getInnerFolders()) {
